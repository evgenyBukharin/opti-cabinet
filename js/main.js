...
if (document.querySelector(".deals")) {
  ...
  sliderData = [{
    ...
    date: "10.08.2023",
    company: "Доктор ост",
    deal: "Создание сайта с калькулятором",
    summ: {
      value: "2 500 00 ₽",
      status: "red"
    },
...
function makeSlider() {
  ...
  formattedData.forEach(array => {
    ...
    array.forEach(row => {
      ...
      dealsItem.querySelector(".deals__col-cashback span").classList.add(`deals__col-cashback-${row.cashback.status}`);
  ...
  const sliderBullets = new core(document.querySelector(`.deals__container-slider-bullets`), {
    slidesPerView: 3,
    spaceBetween: 30,
    speed: 500
  });
  const slider = new core(document.querySelector(`.deals__slider`), {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 500,
    pagination: {
...
if (document.querySelector(".support")) {
  ...
  // 		console.log(e);
  // 	});
  tableSlider_support_sliderData = [{
    stage: "В рамках поддержки",
    contact: "Ольга Келарева",
    deal: "#29186_ Подготовка счета на оплату телефонии",
    isClosed: "да",
    created: "Выплачено",
    comment: "Выплачено",
    category: "Выплачено",
    time: "10 мин",
    completed: "Подготовка счёта на оплату телефонии MCN"
  }, {
    stage: "В рамках поддержки",
    contact: "Ольга Келарева",
    deal: "#29186_ Подготовка счета на оплату телефонии",
